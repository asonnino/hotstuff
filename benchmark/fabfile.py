...
def local(ctx):
    ...
    node_params = {
        ...
        'protocol': 0, # 0 for HotStuff, 1 for AsyncHotStuff, 2 for TwoChainVABA
    }
    try:
...
def remote(ctx):
    ...
    bench_params = {
        'nodes': [32],
        'rate': [1_000, 3_000, 5_000, 7_000, 10_000, 50_000, 100_000, 200_000, 500_000, 750_000, 1000_000],
        'tx_size': 512,
        'faults': 0,
        'duration': 300,
        'runs': 3,
